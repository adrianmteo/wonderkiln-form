...
function createInput(Component, DefaultWrapper) {
    ...
    return function (props) {
        ...
        return (React__default["default"].createElement(Wrapper, __assign({}, props, { value: data, setValue: setValue, onBlur: onBlur, disabled: loading, error: error, eventRef: eventRef, setOnValue: setOnValue }),
            React__default["default"].createElement(Component, __assign({}, props, { value: data, setValue: setValue, onBlur: onBlur, disabled: loading, error: error, eventRef: eventRef, setOnValue: setOnValue }))));
    };
}
