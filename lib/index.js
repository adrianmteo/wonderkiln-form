    ...
    return /** @class */ (function (_super) {
        ...
        Form.prototype.render = function () {
            return (React__default["default"].createElement(FormContext.Provider, { value: {
                ...
                React__default["default"].createElement(Wrapper, __assign({}, this.props, { onSubmit: this.onSubmit, error: this.state.error, errors: this.state.errors, loading: this.state.loading }), this.props.children)));
        };
        return Form;
    }(React.Component));
}
...
function createInput(Component, DefaultWrapper) {
    ...
    return function (props) {
        ...
        var error = React.useMemo(function () { return errors[props.name]; }, [errors, props.name]);
        ...
        return (React__default["default"].createElement(Wrapper, __assign({}, props, { value: data, setValue: setValue, onBlur: onBlur, disabled: props.disabled || loading, error: error, eventRef: eventRef, setOnValue: setOnValue }),
            React__default["default"].createElement(Component, __assign({}, props, { value: data, setValue: setValue, onBlur: onBlur, disabled: props.disabled || loading, error: error, eventRef: eventRef, setOnValue: setOnValue }))));
    };
}
