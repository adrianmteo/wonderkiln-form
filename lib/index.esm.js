...
function createInput(Component, DefaultWrapper) {
    ...
    return function (props) {
        ...
        return (React.createElement(Wrapper, __assign({}, props, { value: data, setValue: setValue, onBlur: onBlur, disabled: props.disabled || loading, error: error, eventRef: eventRef, setOnValue: setOnValue }),
            React.createElement(Component, __assign({}, props, { value: data, setValue: setValue, onBlur: onBlur, disabled: props.disabled || loading, error: error, eventRef: eventRef, setOnValue: setOnValue }))));
    };
}
